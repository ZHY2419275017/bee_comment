package com.mall.comment.filter;
...
public class AllowOrigin implements Filter {
	...
	private final List<String> allowedOrigins = Arrays.asList("http://192.168.0.70:8080","http://localhost:8080","http://192.168.0.23:8888");// 允许跨域的地址
